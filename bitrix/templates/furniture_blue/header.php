...
<link href="<?=SITE_TEMPLATE_PATH?>/colors.css" type="text/css" rel="stylesheet" />
	...
	<link href="<?=SITE_TEMPLATE_PATH?>/bootstrap/css/bootstrap.min.css" type="text/css" rel="stylesheet" />
	<script type="text/javascript" src="<?php echo SITE_TEMPLATE_PATH ?>/bootstrap/js/bootstrap.min.js"></script>
